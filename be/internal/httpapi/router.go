...
func NewRouter(
	...
	protected.Handle("GET /api/spirits/import-template.xlsx", requirePermission(user.PermissionMemorialRead, http.HandlerFunc(memorialHandler.SpiritImportTemplate)))
	protected.Handle("POST /api/spirits/import-preview", requirePermission(user.PermissionMemorialRead, http.HandlerFunc(memorialHandler.SpiritImportPreview)))
	protected.Handle("POST /api/spirits/import", requirePermission(user.PermissionMemorialRead, http.HandlerFunc(memorialHandler.SpiritImport)))
	protected.Handle("GET /api/spirits/export.xlsx", requirePermission(user.PermissionMemorialRead, http.HandlerFunc(memorialHandler.SpiritExport)))
